...
from app.config import AppMetadataConfig, CORSMiddlewareConfig
...
cors_middleware_config = CORSMiddlewareConfig.from_json()
app.add_middleware(CORSMiddleware, **cors_middleware_config.dict())
