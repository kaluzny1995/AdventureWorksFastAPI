...
def test_get_person_phones_should_return_200_response(client, monkeypatch,
    ...
    try:
        # Arrange
        # todo: this and below methods (fixtures_before_test())
        create_tables(postgresdb_engine)
        # todo: move that to common method set user authentication components (AttributesSetter)
        ...
        # todo: move that to common method set providers or services (AttributesSetter)
        ...
        # todo: below 2 methods (fixtures_after_test())
